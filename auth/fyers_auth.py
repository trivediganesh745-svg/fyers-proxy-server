...
import logging
import config
from utils.token_manager import store_tokens, initialize_fyers_model, get_current_tokens

logger = logging.getLogger(__name__)

auth_bp = Blueprint('auth', __name__)

@auth_bp.route('/fyers-login')
def fyers_login():
...
@auth_bp.route('/fyers-auth-callback')
...
def auth_status():
    ...
    from utils.token_manager import get_fyers_instance
